...
public class ReporteQuejas extends HttpServlet {

    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        try{
            JasperReport reporte = (JasperReport)
                    JRLoader.loadObjectFromFile(ReporteMejoresEmpleados.class.getResource("/pe/edu/pucp/CrewmanSystem/reportes/ReporteQuejas.jasper").getFile());
