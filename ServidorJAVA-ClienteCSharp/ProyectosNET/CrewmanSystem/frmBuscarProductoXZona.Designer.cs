namespace CrewmanSystem
{
	partial class frmBuscarProductoXZona
	{
		...
		private void InitializeComponent()
		{
			...
			this.dgvProductoXZona.ColumnHeadersDefaultCellStyle = dataGridViewCellStyle7;
			...
			this.dgvProductoXZona.RowHeadersDefaultCellStyle = dataGridViewCellStyle11;
			...
			this.dgvProductoXZona.RowsDefaultCellStyle = dataGridViewCellStyle12;
			...
			this.CANT_UNIDADES.DefaultCellStyle = dataGridViewCellStyle8;
			...
			this.PRECIO_REAL.DefaultCellStyle = dataGridViewCellStyle10;
